...
import kawasakib from "../data/bikes/kawasakiDataBike"


const KawasakiGallery = () => {
                ...
                {showMore &&
                    <div className='container  bg-gradient p-5 mt-5 rounded-3' style={{ backgroundColor: 'gainsboro' }}>
                        ...
                        <table className=' table  text-start   mt-4  '  >
                            ...
                            <tr>
                                <th>Brakes:</th>
                                <td>{abc.specification.brakes}</td>
                            </tr>
                            <tr>
                                <th>Kerb Weight:</th>
...
export default KawasakiGallery;